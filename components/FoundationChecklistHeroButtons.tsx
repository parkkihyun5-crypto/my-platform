    ...
    <div className="mt-10 w-full max-w-6xl">
      <div>
        ...
        <a
          ...
          className="mt-4 inline-flex w-fit items-center justify-center rounded-full border border-white/20 bg-white/10 px-5 py-2.5 text-sm font-semibold text-white backdrop-blur-md transition-all duration-300 hover:-translate-y-[1px] hover:border-[#E5C996]/50 hover:bg-white/15 hover:text-[#FFF3D7]"
        >
          유형별 법인설립가이드 →
        </a>
      </div>
